...
export default function WorkoutCard({
  ...
  return (
    <Link href={`/workouts/${id || detailsId}`} className="block group">
      <div className="bg-[#121318] border border-zinc-800/80 rounded-2xl overflow-hidden flex flex-col transition-all duration-300 group-hover:border-zinc-700 group-hover:translate-y-[-2px] h-full">
